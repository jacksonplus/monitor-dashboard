...
<template>
  <SidebarMenuButton class="ml-auto" as-child tooltip="Search">
  ...
  <CommandDialog v-model:open="openCommand">
    ...
    <CommandList>
      ...
      <CommandGroup heading="Suggestions">
        <CommandItem value="Dashboard" @select="handleSelectLink('/')">
          Dashboard
          <CommandShortcut>
            <Kbd>G</Kbd>
            <Kbd>D</Kbd>
        ...
        <CommandItem value="Errors" @select="handleSelectLink('/errors')">
          Errors
          <CommandShortcut>
            <Kbd>G</Kbd>
            <Kbd>E</Kbd>
